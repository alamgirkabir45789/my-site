...
import '@custom-styles/menu/menu-types/vertical-menu.scss';
// ** Styles
// import '@styles/base/core/menu/menu-types/vertical-menu.scss';
import '@custom-styles/menu/menu-types/vertical-overlay-menu.scss';
  ...
  return (
    ...
    >
      ...
      <Navbar
        ...
        className={classnames(
          `header-navbar navbar align-items-center ${navbarClasses[navbarType] ||
