...
import { deleteZone, fetchZoneById, toggleZoneSidebar } from '../store/actions';
...
export const ZoneTableColumn = [
  {
    ...
    minWidth: '170px',
    selector: 'zoneOwnerName',
    sortable: true,
    cell: row => row.zoneOwnerName
  },
  {
    name: 'Employee Code',
    minWidth: '150px',
        ...
        <DropdownMenu right>
          ...
          <DropdownItem
            ...
            onClick={() => {
              ...
              store.dispatch(toggleZoneSidebar(true));
            }}
          >
